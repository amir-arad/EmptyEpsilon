...
class SectorsView : public GuiElement
{
  ...
  public:
    ...
    virtual SectorsView* setDistance(float distance) { this->distance = distance; return this; }
    float getDistance() { return distance; }
    virtual SectorsView* setViewPosition(sf::Vector2f view_position) { this->view_position = view_position; return this; }
